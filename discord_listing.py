...
class Listing:
    ...
    def __init__(self, skin_id, asset_id, name, wear, pattern, min_offer, trades, price, cny_to_usd_rate):
    ...
    def __str__(self):
        return f"Skin: {self.name} | Listing Price: {self.listing_price} | Buff Price: {self.buff_price}"\
               f" | Minimum Offer: {self.min_offer} | Trades Done: {self.trades} | Link: {self.link}"
